...
func (c *mockCommentAPI) GetComments(args *models.GetCommentArgs) (result []models.CommentAuthor, err error) {
	...
	var mockCommentResult = []models.CommentAuthor{
		models.CommentAuthor{models.Comment{ID: 1, Body: models.NullString{"Comment No.1", true}, Resource: models.NullString{"readr-post-90", true}, Author: 91, Active: models.NullInt{int64(models.CommentActive["active"].(float64)), true}}, models.NullString{"commenttest1", true}, models.NullString{"", false}, models.NullInt{0, false}, models.NullInt{0, false}},
		models.CommentAuthor{models.Comment{ID: 2, Body: models.NullString{"Comment No.2", true}, Resource: models.NullString{"readr-post-91", true}, Author: 92, Active: models.NullInt{int64(models.CommentActive["active"].(float64)), true}}, models.NullString{"commenttest2", true}, models.NullString{"", true}, models.NullInt{0, false}, models.NullInt{0, false}},
		models.CommentAuthor{models.Comment{ID: 3, Body: models.NullString{"Comment No.3", true}, Resource: models.NullString{"readr-post-90", true}, Author: 92, Active: models.NullInt{int64(models.CommentActive["active"].(float64)), true}, Status: models.NullInt{int64(models.CommentStatus["hide"].(float64)), true}}, models.NullString{"commenttest2", true}, models.NullString{"", true}, models.NullInt{0, false}, models.NullInt{0, false}},
	}
...
func (c *mockCommentAPI) GetReportedComments(args *models.GetReportedCommentArgs) (result []models.ReportedCommentAuthor, err error) {
	...
	var mockCommentResult = []models.CommentAuthor{
		models.CommentAuthor{models.Comment{ID: 1, Body: models.NullString{"Comment No.1", true}, Resource: models.NullString{"readr-post-90", true}, Author: 91, Active: models.NullInt{int64(models.CommentActive["active"].(float64)), true}}, models.NullString{"commenttest1", true}, models.NullString{"", false}, models.NullInt{0, false}, models.NullInt{0, false}},
		models.CommentAuthor{models.Comment{ID: 2, Body: models.NullString{"Comment No.2", true}, Resource: models.NullString{"readr-post-91", true}, Author: 92, Active: models.NullInt{int64(models.CommentActive["active"].(float64)), true}, IP: models.NullString{"5.6.7.8", true}}, models.NullString{"commenttest2", true}, models.NullString{"pi2", true}, models.NullInt{3, true}, models.NullInt{0, true}},
		models.CommentAuthor{models.Comment{ID: 3, Body: models.NullString{"Comment No.3", true}, Resource: models.NullString{"readr-post-90", true}, Author: 92, Active: models.NullInt{int64(models.CommentActive["active"].(float64)), true}, Status: models.NullInt{int64(models.CommentStatus["hide"].(float64)), true}}, models.NullString{"commenttest2", true}, models.NullString{"", true}, models.NullInt{0, false}, models.NullInt{0, false}},
	}
...
func TestRouteComments(t *testing.T) {
	...
	var mockCommentResult = []models.CommentAuthor{
		models.CommentAuthor{models.Comment{ID: 1, Body: models.NullString{"Comment No.1", true}, Resource: models.NullString{"readr-post-90", true}, Author: 91, Active: models.NullInt{int64(models.CommentActive["active"].(float64)), true}}, models.NullString{"commenttest1", true}, models.NullString{"", false}, models.NullInt{0, false}, models.NullInt{0, false}},
		models.CommentAuthor{models.Comment{ID: 2, Body: models.NullString{"Comment No.2", true}, Resource: models.NullString{"readr-post-91", true}, Author: 92, Active: models.NullInt{int64(models.CommentActive["active"].(float64)), true}}, models.NullString{"commenttest2", true}, models.NullString{"", false}, models.NullInt{0, false}, models.NullInt{0, false}},
