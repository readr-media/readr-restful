...
func TestComment(t *testing.T) {
	...
	var mockedComments = []models.InsertCommentArgs{
		models.InsertCommentArgs{
			...
			Body:         rrsql.NullString{"comment body 01", true},
			ParentID:     rrsql.NullInt{0, false},
			Resource:     rrsql.NullString{"http://dev.readr.tw/post/1", true},
			Status:       rrsql.NullInt{1, true},
			Active:       rrsql.NullInt{1, true},
			ResourceName: rrsql.NullString{"post", true},
			ResourceID:   rrsql.NullInt{1, true},
			UpdatedAt:    rrsql.NullTime{Time: time.Date(2018, 1, 2, 3, 4, 5, 6, time.UTC), Valid: true},
		},
		models.InsertCommentArgs{
			Author:       rrsql.NullInt{1, true},
			Body:         rrsql.NullString{"comment body 02", true},
			ParentID:     rrsql.NullInt{0, false},
			Resource:     rrsql.NullString{"http://dev.readr.tw/project/report_slug_1", true},
			Status:       rrsql.NullInt{1, true},
			Active:       rrsql.NullInt{1, true},
			ResourceName: rrsql.NullString{"report", true},
			ResourceID:   rrsql.NullInt{2, true},
			UpdatedAt:    rrsql.NullTime{Time: time.Date(2018, 1, 3, 3, 4, 5, 6, time.UTC), Valid: true},
		},
		models.InsertCommentArgs{
			Author:       rrsql.NullInt{2, true},
			Body:         rrsql.NullString{"comment body 03", true},
			ParentID:     rrsql.NullInt{0, false},
			Resource:     rrsql.NullString{"http://dev.readr.tw/series/project_slug_2/3", true},
			Status:       rrsql.NullInt{0, true},
			Active:       rrsql.NullInt{0, true},
			ResourceName: rrsql.NullString{"memo", true},
			ResourceID:   rrsql.NullInt{3, true},
			UpdatedAt:    rrsql.NullTime{Time: time.Date(2018, 1, 4, 3, 4, 5, 6, time.UTC), Valid: true},
		},
		models.InsertCommentArgs{
			Author:       rrsql.NullInt{2, true},
			Body:         rrsql.NullString{"comment body 04 child of 01", true},
			ParentID:     rrsql.NullInt{1, true},
			Resource:     rrsql.NullString{"http://dev.readr.tw/post/1", true},
			Status:       rrsql.NullInt{1, true},
			Active:       rrsql.NullInt{1, true},
			ResourceName: rrsql.NullString{"post", true},
			ResourceID:   rrsql.NullInt{1, true},
			UpdatedAt:    rrsql.NullTime{Time: time.Date(2018, 1, 5, 3, 4, 5, 6, time.UTC), Valid: true},
		},
		models.InsertCommentArgs{
			Author:       rrsql.NullInt{2, true},
			Body:         rrsql.NullString{"comment body 05 child of 01", true},
			ParentID:     rrsql.NullInt{1, true},
			Resource:     rrsql.NullString{"http://dev.readr.tw/post/1", true},
			Status:       rrsql.NullInt{0, true},
			Active:       rrsql.NullInt{1, true},
			ResourceName: rrsql.NullString{"post", true},
			ResourceID:   rrsql.NullInt{1, true},
			UpdatedAt:    rrsql.NullTime{Time: time.Date(2018, 1, 6, 3, 4, 5, 6, time.UTC), Valid: true},
		},
		models.InsertCommentArgs{
			Author:       rrsql.NullInt{2, true},
			Body:         rrsql.NullString{"comment body 06 child of 01", true},
			ParentID:     rrsql.NullInt{1, true},
			Resource:     rrsql.NullString{"http://dev.readr.tw/post/1", true},
			Status:       rrsql.NullInt{1, true},
			Active:       rrsql.NullInt{1, true},
			ResourceName: rrsql.NullString{"post", true},
			ResourceID:   rrsql.NullInt{1, true},
			UpdatedAt:    rrsql.NullTime{Time: time.Date(2018, 1, 7, 3, 4, 5, 6, time.UTC), Valid: true},
			IP:           rrsql.NullString{"1.2.3.4", true},
		},
	}
	...
	var mockedPosts = []models.Post{
		...
		models.Post{
			...
			Type:          rrsql.NullInt{0, true},
			Link:          rrsql.NullString{"http://dev.readr.tw/posts/2", true},
			Active:        rrsql.NullInt{1, true},
	...
	var mockedReportedComments = []models.ReportedComment{
		models.ReportedComment{
			CommentID: rrsql.NullInt{2, true},
			Reporter:  rrsql.NullInt{1, true},
			Reason:    rrsql.NullString{"Reason1", true},
			Solved:    rrsql.NullInt{0, true},
		},
		models.ReportedComment{
			CommentID: rrsql.NullInt{3, true},
			Reporter:  rrsql.NullInt{1, true},
			Reason:    rrsql.NullString{"Reason2", true},
			Solved:    rrsql.NullInt{0, true},
		},
	}
		...
		for _, tc := range []genericRequestTestcase{
			...
			/*genericRequestTestcase{"InsertCommentWithUrl", "post", "/comment", `{"body":"https://developers.facebook.com/","resource":"http://dev.readr.tw/post/1","author":1,"resource_name":"post","resource_id":1}`, http.StatusOK, ``,
				[]interface{}{[]models.InsertCommentArgs{
					models.InsertCommentArgs{
						Resource:      rrsql.NullString{"http://dev.readr.tw/post/1", true},
						Body:          rrsql.NullString{`<a href="https://developers.facebook.com/" target="_blank">https://developers.facebook.com/</a>`, true},
						ParentID:      rrsql.NullInt{0, false},
						OgTitle:       rrsql.NullString{"Facebook Developers", true},
						OgDescription: rrsql.NullString{"為 Facebook 用戶開發應用程式。深入探討人工智慧、商業工具、遊戲、開放原始碼、發佈、社交網站硬體、社交網站整合，以及虛擬實境。瞭解 Facebook 的全球開發人員教育訓練和交流計畫。", true},
					}}},
			},*/
		} {
			t.Run(tc.name, func(t *testing.T) {
	...
	t.Run("InsertReport", func(t *testing.T) {
		...
		for _, tc := range []genericRequestTestcase{
			genericRequestTestcase{"InsertReportOK", "POST", "/reported_comment", `{"comment_id":1, "reporter":1}`, http.StatusOK, ``, []interface{}{[]models.ReportedComment{models.ReportedComment{
				CommentID: rrsql.NullInt{1, true},
				Reporter:  rrsql.NullInt{1, true},
			}}}},
