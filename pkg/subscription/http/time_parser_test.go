...
func TestPayInterval(t *testing.T) {
	for _, tc := range []struct {
		...
		{"27th-in-feb", time.Date(2019, 2, 27, 1, 2, 3, 4, time.UTC), getBeginTimeOf(2019, 1, 27), getBeginTimeOf(2019, 1, 28)},
		{"non-leap-year-28th-in-feb", time.Date(2019, 2, 28, 1, 2, 3, 4, time.UTC), getBeginTimeOf(2019, 1, 28), getBeginTimeOf(2019, 2, 1)},
		{"leap-year-28th-in-feb", time.Date(2020, 2, 28, 1, 2, 3, 4, time.UTC), getBeginTimeOf(2020, 1, 28), getBeginTimeOf(2020, 1, 29)},
		{"leap-year-29th-in-feb", time.Date(2020, 2, 29, 1, 2, 3, 4, time.UTC), getBeginTimeOf(2020, 1, 29), getBeginTimeOf(2020, 2, 1)},
