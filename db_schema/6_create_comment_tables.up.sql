...
CREATE TABLE comments_reported ( id BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT, comment_id BIGINT UNSIGNED, reporter BIGINT UNSIGNED, reason varchar(500), solved tinyint, created_at datetime, updated_at datetime, ip int unsigned);
